...
class ToolBehaviorTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_tool_request_mapping(self) -> None:
        cases = [
            ...
            (
                server.update_monitor,
                {"monitor_id": "mon-1", "schedule": "every day at 9 AM"},
                "PATCH",
                "/catchAll/monitors/mon-1",
            ...
            (
                server.update_monitor,
                {"monitor_id": "mon-1", "schedule": "every Monday at 6 PM EST",
                 "timezone": "America/New_York"},
                "PATCH",
                "/catchAll/monitors/mon-1",
                {"schedule": "every Monday at 6 PM EST", "timezone": "America/New_York"},
                None,
                True,
            ),
            (
                server.update_monitor,
                {"monitor_id": "mon-1", "schedule": "every day at 9 AM",
                 "timezone": "UTC", "webhook_ids": ["wh-1"], "limit": 25},
                "PATCH",
                "/catchAll/monitors/mon-1",
                {"webhook_ids": ["wh-1"], "limit": 25, "schedule": "every day at 9 AM",
                 "timezone": "UTC"},
                None,
                True,
            ),
